...
#
default_application = 'ciscrowd'    # ordinarily set in base routes.py
...
routes_app = ((r'/(?P<app>ciscrowd|admin)\b.*', r'\g<app>'),
              (r'(.*)', r'ciscrowd'),
              (r'/?(.*)', r'ciscrowd'))
...
#
#routes_onerror = [
#   ('*/404', '/ciscrowd/static/notfound.html'),
#   ('*/*', '/ciscrowd/static/error.html'),
#  ]

# specify action in charge of error handling
#
#error_handler = dict(application='ciscrowd',
#                      controller='error',
#                      function='index')
